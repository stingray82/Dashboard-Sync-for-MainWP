...
define('RUP_MAINWP_CHILD_SYNC_VERSION', '1.0.1');
...
add_action( 'plugins_loaded', function() {
    ...
    $updater_config = [
        ...
        'slug'        => 'child-sync',           // must match your updater‐server slug
        'name'        => 'MainWP Child Sync',         // human‐readable plugin name
        'version'     => RUP_MAINWP_CHILD_SYNC_VERSION, // same as the VERSION constant above
        'key'         => '',                 // your secret key for private updater
        'server'      => 'https://raw.githubusercontent.com/stingray82/Dashboard-Sync-for-MainWP/main/uupd/child-sync/index.json',
    ];
...
add_filter('mainwp_child_stats_get_plugin_info', function($info, $slug) {
    ...
    if ('child-sync/child-sync.php' === $slug) {
        $info['icon'] = 'https://raw.githubusercontent.com/stingray82/Dashboard-Sync-for-MainWP/main/uupd/child-sync/icon-128.png'; // Supported types: jpeg, jpg, gif, ico, png
    }
